 ...
 * @author My Laptop
 */
public class BarJframe extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BarJframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
