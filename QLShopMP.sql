...
MaKho INT,
MaLoai INT,
FOREIGN KEY (MaKho) REFERENCES KHO(MaKho) ON DELETE NO ACTION ON UPDATE CASCADE,
...
Pass NVARCHAR(30),
ChucVu NVARCHAR(500),
FOREIGN KEY (MaAccount) REFERENCES NHANVIEN(MaNV),
);
...
INSERT INTO ACCOUNT
VALUES
(N'ThanhHieu',N'thanhhieu123','Nhân Viên'),
(N'Minhtam',N'minhtam123','Nhân Viên'),
(N'TranLuong',N'tranluong123','Nhân Viên'),
(N'KhanhTam',N'khanhtam123','Nhân Viên'),
(N'TuanHuy',N'tuanhuy123','Nhân Viên')
...
INSERT INTO DONHANG
VALUES
('2023-10-08',N'ThanhHieu',5700000,0.02,5586000,1),
('2023-10-09',N'TranLuong',5700000,0.02,5586000,3),
('2023-10-10',N'TranLuong',5700000,0.02,5586000,3),
('2023-10-11',N'ThanhHieu',5700000,0.02,5586000,1),
('2023-10-12',N'TuanHuy',5700000,0.02,5586000,5),
('2023-10-13',N'TuanHuy',5700000,0.02,5586000,5)
-- PHIẾU NHẬP
